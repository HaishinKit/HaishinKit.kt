package com.haishinkit.rtmp.iso
...
class HevcDecoderConfigurationRecordTest : TestCase() {
    ...
    fun testToCodecSpecificData() {
        ...
        val decode = HevcDecoderConfigurationRecord.decode(buffer)
        val csd0 =
            decode.toCodecSpecificData(emptyList()).firstOrNull { it.key == "csd-0" } ?: return
        assertEquals(
    ...
    companion object {
        const val CSD0 =
            "0000000140010c01ffff016000000300b0000003000003005dac0900000001420101016000000300b0000003000003005da006c201e1cde5aee4c92ea00bb4284a000000014401c0e30f033084"
        const val RECORD_1 =
            "010160000000b000000000005df000fcfdf8f800000f03200001001840010c01ffff016000000300b0000003000003005d15c0902100010023420101016000000300b0000003000003005da00280802d162057b9165535010101008022000100074401c02cbc14c9"
        const val RECORD_2 =
            "012160000000b000000000005df000fcfdf8f800000f03200001001840010c01ffff216000000300b0000003000003005d11c090210001002c420101216000000300b0000003000003005da00280802d16711e4912233924925527e86b4ca489a80808080422000100084401c0252f053240"
    }
}
